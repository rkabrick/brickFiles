...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        subscriptions.push(coc_nvim_1.commands.registerCommand('template.templateHere', () => __awaiter(this, void 0, void 0, function* () { yield template(nvim, tmplPath, 'here'); })));
        ...
        subscriptions.push(coc_nvim_1.workspace.registerKeymap(['n'], 'template-here', () => __awaiter(this, void 0, void 0, function* () { yield template(nvim, tmplPath, 'here'); }), { sync: false }));
...
class Template extends coc_nvim_1.BasicList {
    constructor(nvim, tmplPath) {
        ...
        this.addAction('append', (item) => __awaiter(this, void 0, void 0, function* () {
            ...
            const content = text.split('\n');
            nvim.call('append', [0, content], true);
            yield util_1.afterAppend(nvim);
        }));
    }
    loadItems(_context) {
